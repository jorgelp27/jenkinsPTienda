...
docker-compose -f ptienda/build/Dokerfiles/ubuntu/nest/docker-compose.yml build
docker-compose -f ptienda/build/Dokerfiles/ubuntu/nest/docker-compose.yml up -d
